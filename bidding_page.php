...
if (isset($_POST['submit'])) {
  ...
  if ($result->num_rows >= 0) {
    $sql = "INSERT INTO projectbids(biddersname, biddersdics, bidderbudget, tenderpdf, tokenpb, chahiye ) VALUES ('$biddersname','$biddersdics','$bidderbudget','$tenderpdf','$tokenpb','nhi')";
    $result = mysqli_query($conn, $sql);
    if ($result) {
            ...
            <div id="myModal" class="modal">
                ...
                <div class="modal-content">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="down">
                            <label><input type="text" class="textfield" name="biddersname"
                                    value="<?php echo $biddersname ?>" required><span class="placeholder">Bidder's
                                    Name</span></label><br>

                            <label><input type="text" class="textfield" name="biddersdics"
                                    value="<?php echo $biddersdics ?>" required><span
                                    class="placeholder">Description</span></label><br>

                            <label><input type="number" class="textfield" name="bidderbudget"
                                    value="<?php echo $bidderbudget ?>" required><span class="placeholder">Your
                                    budget</span></label><br>
